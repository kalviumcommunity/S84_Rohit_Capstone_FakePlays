...
function Main() {
  ...
  const characters = [
    ...
    // Predefined characters (e.g. Jenna, Truth & Dare, etc.)
      {
  ...
  const handleDeleteBot = (botPath) => {
    if (window.confirm("Are you sure you want to delete this bot?")) {
      const updatedBots = customBots.filter((bot) => bot.path !== botPath);
  ...
  {allCharacters.map((char, index) => (
    <div
      ...
      onClick={() => navigate(`/chat/${char.path}`)} // Ensure path is correct
    >
